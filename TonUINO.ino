...
//Adapted to layout for LOLIN32


//pin definitions
// DFPlayer Mini
// use hardware serial 
#define RX_MP3 16 //connect to tx on DFPlayer mini
#define TX_MP3 17 //connect to rx on 
...
//Buttons
#define buttonPause 12
#define buttonUp 13
#define buttonDown 14

#define LONG_PRESS 1000 //>1 second -> alternative function for button

// DFPlayer Mini
// SoftwareSerial mySoftwareSerial(RX_MP3, TX_MP3); // RX, TX
...
void setup() {
  ...
  Serial.println(F("Modifierd Based on TonUINO Version 2.0"));
